...
class PurchaseNFTAsset extends BaseAsset {
  ...
  async apply({ asset, stateStore, reducerHandler, transaction }) {
    ...
    token.slikXp = token.slikXp + PURCHASE_SLIK_XP;
    nftTokens[nftTokenIndex] = token;
    await setAllNFTTokens(stateStore, nftTokens);

    //@TODO: Add 3% tax so Jeremy profits =)

    //@TODO: Give x2 SLK token to the purchaser
    //@TODO: Give x1 SLK token to the seller
